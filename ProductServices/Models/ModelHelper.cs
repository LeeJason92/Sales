namespace ProductServices.Models
{
    ...
    {
        public static void CopyProperty(MProductType source, ref MProductType target)
        {
        ...
        public static void CopyProductProperty(MProduct source, ref MProduct target)
        {
            var sProp = source.GetType().GetProperties().ToList();
            foreach (var tProp in target.GetType().GetProperties())
            {
        ...
        public static void CopySparepartTypeProperty(MSparepartType source, ref MSparepartType target)
        {
            var sProp = source.GetType().GetProperties().ToList();
            foreach (var tProp in target.GetType().GetProperties())
            {
        ...
        public static void CopySparepartProperty(MSparepart source, ref MSparepart target)
        {
            var sProp = source.GetType().GetProperties().ToList();
            foreach (var tProp in target.GetType().GetProperties())
            {
        ...
        public static void SetEmptyValue(ref MProductType obj)
        {
