namespace CustomerService.Models
{
    ...
    {
        public static void CopyProperty(MCustomerType source, ref MCustomerType target)
        {
        ...
        public static void CopyCustomerProperty(MCustomer source, ref MCustomer target)
        {
            var sProp = source.GetType().GetProperties().ToList();
            foreach (var tProp in target.GetType().GetProperties())
            {
        ...
        public static void SetEmptyValue(ref MCustomerType obj)
        {
